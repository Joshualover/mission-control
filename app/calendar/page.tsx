...
export default function CalendarPage() {
  const tasks = [
    ...
    { id: 2, title: "团队会议", time: "14:00", status: "pending", type: "recurring" },
    { id: 3, title: "代码审查", time: "16:30", status: "pending", type: "one-time" },
  ];
              ...
              >
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ fontSize: '13px', color: '#9ca3af', fontWeight: '500' }}>
                    {task.time} {task.type === 'recurring' ? '· 循环任务' : '· 单次任务'}
                  </div>
                </div>
